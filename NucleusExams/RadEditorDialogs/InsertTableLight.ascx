...
<div id="InsertTableLight" class="reInsertTableLightWrapper" style="display: none;">
    <table cellspacing="0" cellpadding="0" border="1" class="reControlsLayout">
		...
		<tbody>
			<tr>
				<td colspan="2" class="reTablePropertyControlCell">
					<div class="lightTable" style="border:1 solid;">
			...
			<tr>
				<td colspan="2">
					<table border="1" cellpadding="0" cellspacing="0" class="reConfirmCancelButtonsTblLight">
