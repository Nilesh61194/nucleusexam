...
{
    public partial class MathExtPreview : System.Web.UI.Page
    {
        ...
        protected void BindAnswer()
        {
            ...
            try
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    txtQuestion9.Text = dt.Rows[8]["Answer"].ToString().Trim();
                    ...
                    txtQuestion14.InnerHtml = dt.Rows[13]["Answer"].ToString().Trim();
                    ...
                    txtQuestion23.InnerHtml = dt.Rows[22]["Answer"].ToString().Trim();
                    txtQuestion24.Text = dt.Rows[23]["Answer"].ToString().Trim();
                    txtQuestion25.Text = dt.Rows[24]["Answer"].ToString().Trim();
                    txtQuestion26.Text = dt.Rows[25]["Answer"].ToString().Trim();
                    txtQuestion27.Text = dt.Rows[26]["Answer"].ToString().Trim();
                    txtQuestion28.InnerHtml = dt.Rows[27]["Answer"].ToString().Trim();
                    txtQuestion29.Text = dt.Rows[28]["Answer"].ToString().Trim();
                    txtQuestion30.Text = dt.Rows[29]["Answer"].ToString().Trim();
                }
