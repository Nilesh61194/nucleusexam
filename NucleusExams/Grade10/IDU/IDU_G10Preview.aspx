<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IDU_G10Preview.aspx.cs" Inherits="NucleusExams.Grade10.IDU.IDU_G10Preview" %>
                                    ...
                                    <div style="margin: 10px!important;">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                ...
                                                <select id="txtQuestion4" class="CustomFontSize" runat="server" disabled="disabled">
                                                    <option value=""></option>
                                                ...
                                                <asp:TextBox ID="txtQuestion5" Enabled="false" runat="server" CssClass="divAnswer" TextMode="MultiLine" Width="100%" Height="250px"></asp:TextBox>
                                                <h4><b>Implications of overfishing</b></h4>
                                                <asp:TextBox ID="txtQuestion6" Enabled="false" runat="server" CssClass="divAnswer" TextMode="MultiLine" Width="100%" Height="250px"></asp:TextBox>
                                                <br />

                                            </div>
                                            <div class="col-lg-6">
                                                <h4><b>Stakeholder 2:</b></h4>
                                                <select id="txtQuestion7" class="CustomFontSize" runat="server" disabled="disabled">
                                                    <option value=""></option>
                                                    <option value="Consumer">Consumer</option>
                                                    <option value="Fisherman">Fisherman</option>
                                                    <option value="Corporate fishing company">Corporate fishing company</option>
                                                ...
                                                <h4><b>Perspective</b></h4>
                                                <asp:TextBox ID="txtQuestion8" Enabled="false" runat="server" CssClass="divAnswer" TextMode="MultiLine" Width="100%" Height="250px"></asp:TextBox>
                                                <br />
                                                <br />
                                                <h4><b>Implications of overfishing</b></h4>
                                                <asp:TextBox ID="txtQuestion9" Enabled="false" runat="server" CssClass="divAnswer" TextMode="MultiLine" Width="100%" Height="250px"></asp:TextBox>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <h4><b>Strength</b></h4>
                                                <asp:TextBox ID="txtQuestion10" Enabled="false" runat="server" CssClass="divAnswer" TextMode="MultiLine" Width="100%" Height="250px"></asp:TextBox>
                                                <br />
                                                <h4><b>Opportunity</b></h4>
                                                <asp:TextBox ID="txtQuestion11" Enabled="false" runat="server" CssClass="divAnswer" TextMode="MultiLine" Width="100%" Height="250px"></asp:TextBox>
                                            </div>
                                            <div class="col-lg-6">
                                                <h4><b>Weakness</b></h4>
                                                <asp:TextBox ID="txtQuestion12" Enabled="false" runat="server" CssClass="divAnswer" TextMode="MultiLine" Width="100%" Height="250px"></asp:TextBox>
                                                <br />
                                                <h4><b>Threat</b></h4>
                                                <asp:TextBox ID="txtQuestion13" Enabled="false" runat="server" CssClass="divAnswer" TextMode="MultiLine" Width="100%" Height="250px"></asp:TextBox>
                                            </div>
                                        </div>
                                        <br />
                                        <div>
                                    ...
                                    <div style="margin: 10px!important;">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                ...
                                                <asp:TextBox ID="txtQuestion17" Enabled="false" runat="server" CssClass="divAnswer" TextMode="MultiLine" Width="100%" Height="200px"></asp:TextBox>

                                                <br />
                                                <h4><b>Discipline : </b>Individuals and societies</h4>
                                                <h4><b>Disciplinary knowledge:</b></h4>
                                                <asp:TextBox ID="txtQuestion18" Enabled="false" runat="server" CssClass="divAnswer" TextMode="MultiLine" Width="100%" Height="200px"></asp:TextBox>

                                            </div>
                                            <div class="col-lg-6">
                                                <h4><b>Discipline : </b>Sciences</h4>
                                                <h4><b>Disciplinary knowledge:</b></h4>
                                                <asp:TextBox ID="txtQuestion19" Enabled="false" runat="server" CssClass="divAnswer" TextMode="MultiLine" Width="100%" Height="200px"></asp:TextBox>
                                                <br />
                                                <h4><b>Discipline : </b>Individuals and societies</h4>
                                                <h4><b>Disciplinary knowledge:</b></h4>
                                                <asp:TextBox ID="txtQuestion20" Enabled="false" runat="server" CssClass="divAnswer" TextMode="MultiLine" Width="100%" Height="200px"></asp:TextBox>
                                            </div>
                                        ...
                                        <div>
                                            ...
                                            <div id="txtQuestion21" runat="server" class="divAnswer"></div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div style="border-style: solid; border-width: 1px;">
                                    <div style="margin: 10px!important;">
                                        ...
                                        <div>
                                            ...
                                            <div id="txtQuestion22" runat="server" class="divAnswer"></div>
                                            <br />
                                            <p class="CustomFontSize">Write the mission of the ReGen community here:</p>
                                            <asp:TextBox ID="txtQuestion23" Enabled="false" runat="server" class="divAnswer" TextMode="MultiLine" Width="100%" Height="250px"></asp:TextBox>
                                        </div>
                                        <br />
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <asp:TextBox ID="txtQuestion24" Enabled="false" runat="server" class="divAnswer" TextMode="MultiLine" Width="100%" Height="250px"></asp:TextBox>
                                            </div>
                                            <div class="col-md-6">
                                                <p class="CustomFontSize">Write <b>social behaviours</b> that will have negative consequences on the community here: </p>
                                                <asp:TextBox ID="txtQuestion25" Enabled="false" runat="server" class="divAnswer" TextMode="MultiLine" Width="100%" Height="250px"></asp:TextBox>
                                            </div>
                                        </div>
                                        <br />
                                        <div>
                                            <p class="CustomFontSize">Give a brief <b>reasoning</b> of how guiding principles support the mission of the community here:</p>
                                            <asp:TextBox ID="txtQuestion26" Enabled="false" runat="server" class="divAnswer" TextMode="MultiLine" Width="100%" Height="250px"></asp:TextBox>
                                        </div>
                                    </div>
                                ...
                                <div style="border-style: solid; border-width: 1px;">
                                    <div style="margin: 10px!important;">
                                        ...
                                        <div class="CustomFontSize">
                                            ...
                                            <br />
                                            <select id="txtQuestion28" class="CustomFontSize" style="margin: 10px;" runat="server" disabled="disabled">
                                                <option value=""></option>
                                            ...
                                            <div id="txtQuestion29" runat="server" class="divAnswer"></div>
