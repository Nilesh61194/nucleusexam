<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LLPreview.aspx.cs" Inherits="NucleusExams.Grade10.LL.LLPreview" %>
                                                ...
                                                <div style="border: 1px solid black; margin: 10px; background-color: #9fd8fb;">
                                                    <p class="CustomFontSize">
                                                        <ul class="CustomFontSize">
                                                            ...
                                                            <li>Time recommendation for Q 1(a) to Q 1(d)  - 30 minutes</li>
                                                        </ul>
                                                    </p>
                                                </div>
                                            </div>
                                        ...
                                        <div style="background-color: #9fd8fb;">
                                            ...
                                            <div style="border: 1px solid black; margin: 10px;">
                                                <p class="CustomFontSize" style="margin: 10px;">
                                                    ...
                                                    <br />
                                                    Source: <a href="#">https://www.samoaobserver.ws/category/editorial/32039</a>
                                                    <br />
                                                    <br />
                                ...
                                <div style="border-style: solid; border-width: 1px;">
                                    <div style="margin: 10px!important;">
                                        <div style="background-color: #9fd8fb;">
                                            ...
                                            <div style="margin: 10px;">
                                                <p class="CustomFontSize" style="margin: 10px;">
                                                    Watch this <a href="https://www.youtube.com/embed/LKBNEEY-c3s" target="_blank">illustrated excerpt</a> (insert this video link: <a href="https://www.youtube.com/embed/LKBNEEY-c3s" target="_blank">https://www.youtube.com/watch?v=LKBNEEY-c3s</a>) and read the below transcript from Sea Prayer by Khaled Hosseini containing an imagined letter in the form of a monologue from a Syrian father to his son lying asleep on his lap, on the eve marking the sea crossing to Europe to seek refuge and safety, attempt the Q.3  that follows:
                                                </p>
                                            </div>
                                            <div style="border: 1px solid black; margin: 10px;">
                                                <p class="CustomFontSize" style="margin: 10px;">
