<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IDU_G9Preview.aspx.cs" Inherits="NucleusExams.Grade9.IDU.IDU_G9Preview" %>
                            ...
                            <div style="margin: 20px;">
                                ...
                                <div style="border-style: solid; border-width: 1px;">
                                    <div style="margin: 10px!important;">
                                        ...
                                        <div>
                                            <p class="CustomFontSize">
                                                Below are three quotations from the extract. <b>Select</b> which quotation is best described by the atmosphere. Drag and drop the atmosphere to the
                                                appropriate boxes beside the quotation. Leave one box blank.
                                            </p>
                                        </div>
                                        <div class="row">
                                            <p class="text-center" style="font-weight: 700;"><b>Suspenseful &nbsp;&nbsp;&nbsp;&nbsp; Gloomy</b></p>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12">
                                                <table style="margin-left: 50px; margin-right: 50px;" border="1">
                                                    <tr>
                                                        ...
                                                        <td style="width: 30%" class="text-center">
                                                            <asp:TextBox ID="txtQuestion4" runat="server" Enabled="false" CssClass="txtBlank"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td style="width: 70%">
                                                        ...
                                                        <td style="width: 30%" class="text-center">
                                                            <asp:TextBox ID="txtQuestion5" runat="server" Enabled="false" CssClass="txtBlank"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td style="width: 70%">
                                                        ...
                                                        <td style="width: 30%" class="text-center">
                                                            <asp:TextBox ID="txtQuestion6" runat="server" Enabled="false" CssClass="txtBlank"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </div>
                                        ...
                                        <div>
                                            <p class="CustomFontSize">
                                                <b>Explain</b> the effect on the audience of the following literary devices. Use an example from the extract to support your answer.
                                            </p>
                            ...
                            <div style="margin: 20px">
                                ...
                                <div style="border-style: solid; border-width: 1px;">
                                    <div style="margin: 10px!important;">
                                        <div class="CustomFontSize">
                                            <p>
                                                During an interdisciplinary unit and you will have developed your interdisciplinary understanding. <b>Discuss</b> the consequences of your understanding
                                            </p>
